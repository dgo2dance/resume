export default {
  name: '段书勇',
  tel: '18203600579',
  email: 'duanshuyong0@163.com',
  github: 'https://github.com/willcodeart',
  website: 'https://willcodeart.github.io/',
  zhihu: 'https://www.zhihu.com/column/socoolwangwang',
  resume: 'https://willcodeart.github.io/resume/',
  edus: [
    {
      left: '吉林大学',
      right: '2009年09月 - 2011年06月',
      children: [
        {
          left: '专业：商学院 管理科学与工程系 研究方向:商务智能,数据挖掘',
        //  right: '2009年09月 - 2011年06月'
        },
        {
          left: '学位：硕士',
        //  right: '2005年09月 - 2009年6月'
        },
        {
          left: '荣誉：2年一等奖学金,优秀硕士毕业论文'
        },
        {
          left: '论文：在导师带领下,发布1篇A级,1篇C级论文'
        }
      ]
    },
    {
      left: '沈阳理工大学',
      right: '2005年09月 - 2009年06月',
      children: [
        {
          left: '专业：艺术设计学院 工业设计系',
        //  right: '2005年09月 - 2009年6月'
        },
        {
          left: '学位：本科',
        ...
        {
          left: '荣誉：4年一等奖学金,2次优秀学生干部,1次优秀团员',
        },
      ]
    },
    {
      ...
      children: [
        ...
        {
          left: '荣誉：程序员,软件设计师职称证书,优秀毕业设计',
        },
      ]
    },
  ],
  skills: {
    frameworks: ['Java', 'Python', 'TypeScript', 'Node.js'],
    libraries: ['Java', 'Python', 'Node.js'],
    tools: ['Vue.js', 'React.js', 'TypeScript', 'Node.js'],
    tests: ['Ps', 'Axure'],
  },
  works: [
    {
      ...
      right: '2021年03月 - 至今',
      children: [
        {left: '合伙人,产品及工程负责，从事wms,在线培训,在线组织人员连接项目工作'},
      ]
    },
    {
      left: '中移在线服务有限公司@云平台部',
      link: '',
      right: '2017年03月 - 2021年03月',
      children: [
        {left: '项目负责,从事外呼,聚合支付清结算,银企互联,工会报账,智能排班,人力资本管理等系统设计开发工作'},
        {left: '协同多个厂商,多银行,业务部门,关联系统方,集团方等多个相关方促进目标的达成'},
      ]
    }, 
    {
      left: '宇通客车股份有限公司@信息部',
      link: '',
      right: '2011年07月 - 2016年12月',
      children: [
        {left: '技术负责人,先后做过销售、研发、供应链、生产、质量、售后等不同领域多个系统'},
        {left: '研发模块技术组长及外部数个合作伙伴人员的管理工作(30-40),负责系统业务工作,负责合作伙伴人员的招聘选用育留及对接核算结算等工作'},
      ]
    },
  ],
  interns: [
  ...
  projects: [
    ...
    //  link: 'https://github.com/Haixiang6123/one-day-one-npm-lib',
      right: '2021年03月',
      children: [
        {left: '承接wms与第三方渠道（京东、拼多多）、第三方快递（顺风、京东）、ERP(sap、聚水潭)、内部设备（立库、分拣机、AGV、终端打印、语音拣选）等部分对接及出入库库内管理功能的迭代，问题解决；'},
        {left: 'springboot、java、mysql'},
      ]
    },
    ...
    {
      left: '吉林大学商学院与卓展购物中心商业智能合作项目',
    //  link: 'https://haixiang6123.github.io/guitar-editor/#/',
      right: '2009年09月',
      children: [
        {left: '建立RFM模型，研究实现客户细分，针对不同类别价值的客户群实施相应的营销策略，并在实现客户细分之上，研究如何为会员卡标准的制定提供依据；研究消费产品之间的关联，以辅助产品布局管理和实现交叉销售，预研商品之间的关联推荐；'},
        {left: '使用SQL负责前期的数据清理，运用RFM模型计算客户价值，实现客户聚类细分，分析各个类别的特征与相应采取的营销策略，挖掘客户消费数据的关联推荐；'},
      ]
    },
  ],
}
